...
abstract class Teams implements ActiveRecordInterface
{
     ...
     * Note: this column has a database default value of: 'DEFUNCT'
     * @var        string
     */
    protected $status;
    ...
    public function setLink($v)
    {
        ...
        if ($this->link !== $v) {
            $this->link = $v;
            $this->modifiedColumns[TeamsTableMap::COL_LINK] = true;
        }
    ...
    public function setOwner($v)
    {
        ...
        if ($this->owner !== $v) {
            $this->owner = $v;
            $this->modifiedColumns[TeamsTableMap::COL_OWNER] = true;
        }
    ...
    public function setNickname($v)
    {
        ...
        if ($this->nickname !== $v) {
            $this->nickname = $v;
            $this->modifiedColumns[TeamsTableMap::COL_NICKNAME] = true;
        }
    ...
    public function setTeamAbbrev($v)
    {
        ...
        if ($this->team_abbrev !== $v) {
            $this->team_abbrev = $v;
            $this->modifiedColumns[TeamsTableMap::COL_TEAM_ABBREV] = true;
        }
    ...
    public function setDivision($v)
    {
        ...
        if ($this->division !== $v) {
            $this->division = $v;
            $this->modifiedColumns[TeamsTableMap::COL_DIVISION] = true;
        }
    ...
    public function setEmail($v)
    {
        ...
        if ($this->email !== $v) {
            $this->email = $v;
            $this->modifiedColumns[TeamsTableMap::COL_EMAIL] = true;
        }
    ...
    public function setStatus($v)
    {
        ...
        if ($this->status !== $v) {
            $this->status = $v;
            $this->modifiedColumns[TeamsTableMap::COL_STATUS] = true;
        }
    ...
    public function setComment($v)
    {
        ...
        if ($this->comment !== $v) {
            $this->comment = $v;
            $this->modifiedColumns[TeamsTableMap::COL_COMMENT] = true;
        }
    ...
    public function setLeague($v)
    {
        ...
        if ($this->league !== $v) {
            $this->league = $v;
            $this->modifiedColumns[TeamsTableMap::COL_LEAGUE] = true;
        }

        if ($this->aLeagueRef !== null && $this->aLeagueRef->getLeague() !== $v) {
            $this->aLeagueRef = null;
        }
    ...
    public function setUsed($v)
    {
        ...
        if ($this->used !== $v) {
            $this->used = $v;
            $this->modifiedColumns[TeamsTableMap::COL_USED] = true;
        }
    ...
    public function setEmail2($v)
    {
        ...
        if ($this->email2 !== $v) {
            $this->email2 = $v;
            $this->modifiedColumns[TeamsTableMap::COL_EMAIL2] = true;
        }
    ...
    public function setAddress($v)
    {
        ...
        if ($this->address !== $v) {
            $this->address = $v;
            $this->modifiedColumns[TeamsTableMap::COL_ADDRESS] = true;
        }
    ...
    public function setCity($v)
    {
        ...
        if ($this->city !== $v) {
            $this->city = $v;
            $this->modifiedColumns[TeamsTableMap::COL_CITY] = true;
        }
    ...
    public function setState($v)
    {
        ...
        if ($this->state !== $v) {
            $this->state = $v;
            $this->modifiedColumns[TeamsTableMap::COL_STATE] = true;
        }
    ...
    public function setZip($v)
    {
        ...
        if ($this->zip !== $v) {
            $this->zip = $v;
            $this->modifiedColumns[TeamsTableMap::COL_ZIP] = true;
        }
    ...
    public function setPhone($v)
    {
        ...
        if ($this->phone !== $v) {
            $this->phone = $v;
            $this->modifiedColumns[TeamsTableMap::COL_PHONE] = true;
        }
    ...
    public function setTeamLink($v)
    {
        ...
        if ($this->team_link !== $v) {
            $this->team_link = $v;
            $this->modifiedColumns[TeamsTableMap::COL_TEAM_LINK] = true;
        }
    ...
    public function setTradeLink($v)
    {
        ...
        if ($this->trade_link !== $v) {
            $this->trade_link = $v;
            $this->modifiedColumns[TeamsTableMap::COL_TRADE_LINK] = true;
        }
    ...
    public function setDraftLink($v)
    {
        ...
        if ($this->draft_link !== $v) {
            $this->draft_link = $v;
            $this->modifiedColumns[TeamsTableMap::COL_DRAFT_LINK] = true;
        }
    ...
    public function setAwardsLink($v)
    {
        ...
        if ($this->awards_link !== $v) {
            $this->awards_link = $v;
            $this->modifiedColumns[TeamsTableMap::COL_AWARDS_LINK] = true;
        }
    ...
    public function setAim($v)
    {
        ...
        if ($this->aim !== $v) {
            $this->aim = $v;
            $this->modifiedColumns[TeamsTableMap::COL_AIM] = true;
        }
    ...
    public function setYahoo($v)
    {
        ...
        if ($this->yahoo !== $v) {
            $this->yahoo = $v;
            $this->modifiedColumns[TeamsTableMap::COL_YAHOO] = true;
        }
    ...
    public function setCreateTs($v)
    {
        ...
        if ($this->create_ts !== null || $dt !== null) {
            if ($this->create_ts === null || $dt === null || $dt->format("Y-m-d H:i:s") !== $this->create_ts->format("Y-m-d H:i:s")) {
                ...
                $this->modifiedColumns[TeamsTableMap::COL_CREATE_TS] = true;
            }
    ...
    public function setMaintTs($v)
    {
        ...
        if ($this->maint_ts !== null || $dt !== null) {
            if ($this->maint_ts === null || $dt === null || $dt->format("Y-m-d H:i:s") !== $this->maint_ts->format("Y-m-d H:i:s")) {
                ...
                $this->modifiedColumns[TeamsTableMap::COL_MAINT_TS] = true;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : TeamsTableMap::translateFieldName('Link', TableMap::TYPE_PHPNAME, $indexType)];
            $this->link = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : TeamsTableMap::translateFieldName('Owner', TableMap::TYPE_PHPNAME, $indexType)];
            $this->owner = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : TeamsTableMap::translateFieldName('Name', TableMap::TYPE_PHPNAME, $indexType)];
            $this->name = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : TeamsTableMap::translateFieldName('Nickname', TableMap::TYPE_PHPNAME, $indexType)];
            $this->nickname = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : TeamsTableMap::translateFieldName('TeamAbbrev', TableMap::TYPE_PHPNAME, $indexType)];
            $this->team_abbrev = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : TeamsTableMap::translateFieldName('Division', TableMap::TYPE_PHPNAME, $indexType)];
            $this->division = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 7 + $startcol : TeamsTableMap::translateFieldName('Email', TableMap::TYPE_PHPNAME, $indexType)];
            $this->email = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 8 + $startcol : TeamsTableMap::translateFieldName('Status', TableMap::TYPE_PHPNAME, $indexType)];
            $this->status = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 9 + $startcol : TeamsTableMap::translateFieldName('Comment', TableMap::TYPE_PHPNAME, $indexType)];
            $this->comment = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 10 + $startcol : TeamsTableMap::translateFieldName('League', TableMap::TYPE_PHPNAME, $indexType)];
            $this->league = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 11 + $startcol : TeamsTableMap::translateFieldName('Used', TableMap::TYPE_PHPNAME, $indexType)];
            $this->used = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 12 + $startcol : TeamsTableMap::translateFieldName('Email2', TableMap::TYPE_PHPNAME, $indexType)];
            $this->email2 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 13 + $startcol : TeamsTableMap::translateFieldName('Address', TableMap::TYPE_PHPNAME, $indexType)];
            $this->address = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 14 + $startcol : TeamsTableMap::translateFieldName('City', TableMap::TYPE_PHPNAME, $indexType)];
            $this->city = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 15 + $startcol : TeamsTableMap::translateFieldName('State', TableMap::TYPE_PHPNAME, $indexType)];
            $this->state = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 16 + $startcol : TeamsTableMap::translateFieldName('Zip', TableMap::TYPE_PHPNAME, $indexType)];
            $this->zip = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 17 + $startcol : TeamsTableMap::translateFieldName('Phone', TableMap::TYPE_PHPNAME, $indexType)];
            $this->phone = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 18 + $startcol : TeamsTableMap::translateFieldName('TeamLink', TableMap::TYPE_PHPNAME, $indexType)];
            $this->team_link = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 19 + $startcol : TeamsTableMap::translateFieldName('TradeLink', TableMap::TYPE_PHPNAME, $indexType)];
            $this->trade_link = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 20 + $startcol : TeamsTableMap::translateFieldName('DraftLink', TableMap::TYPE_PHPNAME, $indexType)];
            $this->draft_link = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 21 + $startcol : TeamsTableMap::translateFieldName('AwardsLink', TableMap::TYPE_PHPNAME, $indexType)];
            $this->awards_link = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 22 + $startcol : TeamsTableMap::translateFieldName('Aim', TableMap::TYPE_PHPNAME, $indexType)];
            $this->aim = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 23 + $startcol : TeamsTableMap::translateFieldName('Yahoo', TableMap::TYPE_PHPNAME, $indexType)];
            $this->yahoo = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 24 + $startcol : TeamsTableMap::translateFieldName('CreateTs', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->create_ts = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 25 + $startcol : TeamsTableMap::translateFieldName('MaintTs', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            ...
            return $startcol + 26; // 26 = TeamsTableMap::NUM_HYDRATE_COLUMNS.
    ...
    {
        if ($this->aDivisionRef !== null && $this->division !== $this->aDivisionRef->getDivision()) {
            $this->aDivisionRef = null;
        }
        if ($this->aLeagueRef !== null && $this->league !== $this->aLeagueRef->getLeague()) {
            $this->aLeagueRef = null;
        }
    } // ensureConsistency
    ...
    protected function doSave(ConnectionInterface $con)
    {
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->aLeagueRef !== null) {
                if ($this->aLeagueRef->isModified() || $this->aLeagueRef->isNew()) {
                    $affectedRows += $this->aLeagueRef->save($con);
                }
                $this->setLeagueRef($this->aLeagueRef);
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(TeamsTableMap::COL_LINK)) {
            $modifiedColumns[':p' . $index++]  = 'link';
        }
        if ($this->isColumnModified(TeamsTableMap::COL_OWNER)) {
            $modifiedColumns[':p' . $index++]  = 'Owner';
        }
        if ($this->isColumnModified(TeamsTableMap::COL_NAME)) {
            $modifiedColumns[':p' . $index++]  = 'Name';
        }
        if ($this->isColumnModified(TeamsTableMap::COL_NICKNAME)) {
            $modifiedColumns[':p' . $index++]  = 'nickname';
        }
        if ($this->isColumnModified(TeamsTableMap::COL_TEAM_ABBREV)) {
            $modifiedColumns[':p' . $index++]  = 'Team_Abbrev';
        }
        if ($this->isColumnModified(TeamsTableMap::COL_DIVISION)) {
            $modifiedColumns[':p' . $index++]  = 'Division';
        }
        if ($this->isColumnModified(TeamsTableMap::COL_EMAIL)) {
            $modifiedColumns[':p' . $index++]  = 'email';
        }
        if ($this->isColumnModified(TeamsTableMap::COL_STATUS)) {
            $modifiedColumns[':p' . $index++]  = 'status';
        }
        if ($this->isColumnModified(TeamsTableMap::COL_COMMENT)) {
            $modifiedColumns[':p' . $index++]  = 'comment';
        }
        if ($this->isColumnModified(TeamsTableMap::COL_LEAGUE)) {
            $modifiedColumns[':p' . $index++]  = 'league';
        }
        if ($this->isColumnModified(TeamsTableMap::COL_USED)) {
            $modifiedColumns[':p' . $index++]  = 'used';
        }
        if ($this->isColumnModified(TeamsTableMap::COL_EMAIL2)) {
            $modifiedColumns[':p' . $index++]  = 'email2';
        }
        if ($this->isColumnModified(TeamsTableMap::COL_ADDRESS)) {
            $modifiedColumns[':p' . $index++]  = 'address';
        }
        if ($this->isColumnModified(TeamsTableMap::COL_CITY)) {
            $modifiedColumns[':p' . $index++]  = 'city';
        }
        if ($this->isColumnModified(TeamsTableMap::COL_STATE)) {
            $modifiedColumns[':p' . $index++]  = 'state';
        }
        if ($this->isColumnModified(TeamsTableMap::COL_ZIP)) {
            $modifiedColumns[':p' . $index++]  = 'zip';
        }
        if ($this->isColumnModified(TeamsTableMap::COL_PHONE)) {
            $modifiedColumns[':p' . $index++]  = 'phone';
        }
        if ($this->isColumnModified(TeamsTableMap::COL_TEAM_LINK)) {
            $modifiedColumns[':p' . $index++]  = 'team_link';
        }
        if ($this->isColumnModified(TeamsTableMap::COL_TRADE_LINK)) {
            $modifiedColumns[':p' . $index++]  = 'trade_link';
        }
        if ($this->isColumnModified(TeamsTableMap::COL_DRAFT_LINK)) {
            $modifiedColumns[':p' . $index++]  = 'draft_link';
        }
        if ($this->isColumnModified(TeamsTableMap::COL_AWARDS_LINK)) {
            $modifiedColumns[':p' . $index++]  = 'awards_link';
        }
        if ($this->isColumnModified(TeamsTableMap::COL_AIM)) {
            $modifiedColumns[':p' . $index++]  = 'aim';
        }
        if ($this->isColumnModified(TeamsTableMap::COL_YAHOO)) {
            $modifiedColumns[':p' . $index++]  = 'yahoo';
        }
        if ($this->isColumnModified(TeamsTableMap::COL_CREATE_TS)) {
            $modifiedColumns[':p' . $index++]  = 'create_ts';
        }
        if ($this->isColumnModified(TeamsTableMap::COL_MAINT_TS)) {
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[24], $arr)) {
            $this->setCreateTs($arr[$keys[24]]);
        }
        if (array_key_exists($keys[25], $arr)) {
            $this->setMaintTs($arr[$keys[25]]);
        }
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(TeamsTableMap::COL_LINK)) {
            $criteria->add(TeamsTableMap::COL_LINK, $this->link);
        }
        if ($this->isColumnModified(TeamsTableMap::COL_OWNER)) {
            $criteria->add(TeamsTableMap::COL_OWNER, $this->owner);
        }
        if ($this->isColumnModified(TeamsTableMap::COL_NAME)) {
            $criteria->add(TeamsTableMap::COL_NAME, $this->name);
        }
        if ($this->isColumnModified(TeamsTableMap::COL_NICKNAME)) {
            $criteria->add(TeamsTableMap::COL_NICKNAME, $this->nickname);
        }
        if ($this->isColumnModified(TeamsTableMap::COL_TEAM_ABBREV)) {
            $criteria->add(TeamsTableMap::COL_TEAM_ABBREV, $this->team_abbrev);
        }
        if ($this->isColumnModified(TeamsTableMap::COL_DIVISION)) {
            $criteria->add(TeamsTableMap::COL_DIVISION, $this->division);
        }
        if ($this->isColumnModified(TeamsTableMap::COL_EMAIL)) {
            $criteria->add(TeamsTableMap::COL_EMAIL, $this->email);
        }
        if ($this->isColumnModified(TeamsTableMap::COL_STATUS)) {
            $criteria->add(TeamsTableMap::COL_STATUS, $this->status);
        }
        if ($this->isColumnModified(TeamsTableMap::COL_COMMENT)) {
            $criteria->add(TeamsTableMap::COL_COMMENT, $this->comment);
        }
        if ($this->isColumnModified(TeamsTableMap::COL_LEAGUE)) {
            $criteria->add(TeamsTableMap::COL_LEAGUE, $this->league);
        }
        if ($this->isColumnModified(TeamsTableMap::COL_USED)) {
            $criteria->add(TeamsTableMap::COL_USED, $this->used);
        }
        if ($this->isColumnModified(TeamsTableMap::COL_EMAIL2)) {
            $criteria->add(TeamsTableMap::COL_EMAIL2, $this->email2);
        }
        if ($this->isColumnModified(TeamsTableMap::COL_ADDRESS)) {
            $criteria->add(TeamsTableMap::COL_ADDRESS, $this->address);
        }
        if ($this->isColumnModified(TeamsTableMap::COL_CITY)) {
            $criteria->add(TeamsTableMap::COL_CITY, $this->city);
        }
        if ($this->isColumnModified(TeamsTableMap::COL_STATE)) {
            $criteria->add(TeamsTableMap::COL_STATE, $this->state);
        }
        if ($this->isColumnModified(TeamsTableMap::COL_ZIP)) {
            $criteria->add(TeamsTableMap::COL_ZIP, $this->zip);
        }
        if ($this->isColumnModified(TeamsTableMap::COL_PHONE)) {
            $criteria->add(TeamsTableMap::COL_PHONE, $this->phone);
        }
        if ($this->isColumnModified(TeamsTableMap::COL_TEAM_LINK)) {
            $criteria->add(TeamsTableMap::COL_TEAM_LINK, $this->team_link);
        }
        if ($this->isColumnModified(TeamsTableMap::COL_TRADE_LINK)) {
            $criteria->add(TeamsTableMap::COL_TRADE_LINK, $this->trade_link);
        }
        if ($this->isColumnModified(TeamsTableMap::COL_DRAFT_LINK)) {
            $criteria->add(TeamsTableMap::COL_DRAFT_LINK, $this->draft_link);
        }
        if ($this->isColumnModified(TeamsTableMap::COL_AWARDS_LINK)) {
            $criteria->add(TeamsTableMap::COL_AWARDS_LINK, $this->awards_link);
        }
        if ($this->isColumnModified(TeamsTableMap::COL_AIM)) {
            $criteria->add(TeamsTableMap::COL_AIM, $this->aim);
        }
        if ($this->isColumnModified(TeamsTableMap::COL_YAHOO)) {
            $criteria->add(TeamsTableMap::COL_YAHOO, $this->yahoo);
        }
        if ($this->isColumnModified(TeamsTableMap::COL_CREATE_TS)) {
            $criteria->add(TeamsTableMap::COL_CREATE_TS, $this->create_ts);
        }
        if ($this->isColumnModified(TeamsTableMap::COL_MAINT_TS)) {
            $criteria->add(TeamsTableMap::COL_MAINT_TS, $this->maint_ts);
        }
    ...
    public function setDivisionRef(ChildDivisionRef $v = null)
    {
        if ($v === null) {
            ...
            $this->setDivision($v->getDivision());
        }
    ...
    {
        if ($this->aDivisionRef === null && (($this->division !== "" && $this->division !== null))) {
            $this->aDivisionRef = ChildDivisionRefQuery::create()->findPk($this->division, $con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aDivisionRef->addTeamss($this);
             */
        }
    ...
    /**
     * Declares an association between this object and a ChildLeagueRef object.
     *
     * @param  ChildLeagueRef $v
     * @return $this|\Teams The current object (for fluent API support)
     * @throws PropelException
     */
    public function setLeagueRef(ChildLeagueRef $v = null)
    {
        if ($v === null) {
            $this->setLeague('');
        } else {
            $this->setLeague($v->getLeague());
        }

        $this->aLeagueRef = $v;

        // Add binding for other direction of this n:n relationship.
        // If this object has already been added to the ChildLeagueRef object, it will not be re-added.
        if ($v !== null) {
            $v->addTeams($this);
        }
     ...
     * @return ObjectCollection|ChildPlayers[] List of ChildPlayers objects
     */
    public function getPlayerssJoinDivisionRef(Criteria $criteria = null, ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildPlayersQuery::create(null, $criteria);
        $query->joinWith('DivisionRef', $joinBehavior);
