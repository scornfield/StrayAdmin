...
/**
 * Base class that represents a row from the 'mlb_team_ref' table.
 *
 *
 *
* @package    propel.generator..Base
*/
abstract class MlbTeamRef implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\MlbTeamRefTableMap';
    ...
    /**
     * Initializes internal state of Base\MlbTeamRef object.
     * @see applyDefaults()
     */
    ...
    /**
     * Compares this with another <code>MlbTeamRef</code> instance.  If
     * <code>obj</code> is an instance of <code>MlbTeamRef</code>, delegates to
     * <code>equals(MlbTeamRef)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|MlbTeamRef The current object, for fluid interface
     */
     ...
     * @return $this|\MlbTeamRef The current object (for fluent API support)
     */
    public function setMlb($v)
    {
        ...
        if ($this->mlb !== $v) {
            $this->mlb = $v;
            $this->modifiedColumns[MlbTeamRefTableMap::COL_MLB] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : MlbTeamRefTableMap::translateFieldName('Mlb', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 1; // 1 = MlbTeamRefTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\MlbTeamRef'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildMlbTeamRefQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see MlbTeamRef::setDeleted()
     * @see MlbTeamRef::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildMlbTeamRefQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                MlbTeamRefTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(MlbTeamRefTableMap::COL_MLB)) {
            $modifiedColumns[':p' . $index++]  = 'mlb';
        }

        $sql = sprintf(
            'INSERT INTO mlb_team_ref (%s) VALUES (%s)',
    ...
    {
        $pos = MlbTeamRefTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['MlbTeamRef'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['MlbTeamRef'][$this->hashCode()] = true;
        $keys = MlbTeamRefTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getMlb(),
        );
    ...
    /**
     * Generic method to set the primary key (mlb column).
     *
     ...
     * objects.
     *
     * @param      object $copyObj An object of \MlbTeamRef (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \MlbTeamRef Clone of current object.
     * @throws PropelException
     */
     ...
     * If this ChildMlbTeamRef is new, it will return
    ...
    public function setPlayerss(Collection $playerss, ConnectionInterface $con = null)
    {
        ...
        foreach ($playerssToDelete as $playersRemoved) {
            $playersRemoved->setMlbTeamRef(null);
        }
     ...
     * Otherwise if this MlbTeamRef is new, it will return
     * an empty collection; or if this MlbTeamRef has previously
     * been saved, it will retrieve related Playerss from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in MlbTeamRef.
     *
     * @param      Criteria $criteria optional Criteria object to narrow the query
     * @param      ConnectionInterface $con optional connection object
    ...
    {
        return (string) $this->exportTo(MlbTeamRefTableMap::DEFAULT_STRING_FORMAT);
    }
