...
/**
 * Base class that represents a row from the 'position_ref' table.
 *
 *
 *
* @package    propel.generator..Base
*/
abstract class PositionRef implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\PositionRefTableMap';
    ...
    /**
     * Initializes internal state of Base\PositionRef object.
     * @see applyDefaults()
     */
    ...
    /**
     * Compares this with another <code>PositionRef</code> instance.  If
     * <code>obj</code> is an instance of <code>PositionRef</code>, delegates to
     * <code>equals(PositionRef)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|PositionRef The current object, for fluid interface
     */
     ...
     * @return $this|\PositionRef The current object (for fluent API support)
     */
    public function setPosition($v)
    {
        ...
        if ($this->position !== $v) {
            $this->position = $v;
            $this->modifiedColumns[PositionRefTableMap::COL_POSITION] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : PositionRefTableMap::translateFieldName('Position', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 1; // 1 = PositionRefTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\PositionRef'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildPositionRefQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see PositionRef::setDeleted()
     * @see PositionRef::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildPositionRefQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                PositionRefTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(PositionRefTableMap::COL_POSITION)) {
            $modifiedColumns[':p' . $index++]  = 'position';
        }

        $sql = sprintf(
            'INSERT INTO position_ref (%s) VALUES (%s)',
    ...
    {
        $pos = PositionRefTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['PositionRef'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['PositionRef'][$this->hashCode()] = true;
        $keys = PositionRefTableMap::getFieldNames($keyType);
        $result = array(
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(PositionRefTableMap::COL_POSITION)) {
            $criteria->add(PositionRefTableMap::COL_POSITION, $this->position);
        }
    ...
    {
        $criteria = ChildPositionRefQuery::create();
        $criteria->add(PositionRefTableMap::COL_POSITION, $this->position);
    ...
    /**
     * Generic method to set the primary key (position column).
     *
     ...
     * objects.
     *
     * @param      object $copyObj An object of \PositionRef (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \PositionRef Clone of current object.
     * @throws PropelException
     */
     ...
     * If this ChildPositionRef is new, it will return
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildPositionRef The current object (for fluent API support)
     */
    public function setPlayerss(Collection $playerss, ConnectionInterface $con = null)
    {
        ...
        foreach ($playerssToDelete as $playersRemoved) {
            $playersRemoved->setPositionRef(null);
        }
     ...
     * Otherwise if this PositionRef is new, it will return
     * an empty collection; or if this PositionRef has previously
     * been saved, it will retrieve related Playerss from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in PositionRef.
     *
     * @param      Criteria $criteria optional Criteria object to narrow the query
     * @param      ConnectionInterface $con optional connection object
    ...
    {
        return (string) $this->exportTo(PositionRefTableMap::DEFAULT_STRING_FORMAT);
    }
