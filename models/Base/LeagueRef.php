...
/**
 * Base class that represents a row from the 'league_ref' table.
 *
 *
 *
* @package    propel.generator..Base
*/
abstract class LeagueRef implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\LeagueRefTableMap';
    ...
    /**
     * Initializes internal state of Base\LeagueRef object.
     * @see applyDefaults()
     */
    ...
    /**
     * Compares this with another <code>LeagueRef</code> instance.  If
     * <code>obj</code> is an instance of <code>LeagueRef</code>, delegates to
     * <code>equals(LeagueRef)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|LeagueRef The current object, for fluid interface
     */
     ...
     * @return $this|\LeagueRef The current object (for fluent API support)
     */
    public function setLeague($v)
    {
        ...
        if ($this->league !== $v) {
            $this->league = $v;
            $this->modifiedColumns[LeagueRefTableMap::COL_LEAGUE] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : LeagueRefTableMap::translateFieldName('League', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 1; // 1 = LeagueRefTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\LeagueRef'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildLeagueRefQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see LeagueRef::setDeleted()
     * @see LeagueRef::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildLeagueRefQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                LeagueRefTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(LeagueRefTableMap::COL_LEAGUE)) {
            $modifiedColumns[':p' . $index++]  = 'league';
        }

        $sql = sprintf(
            'INSERT INTO league_ref (%s) VALUES (%s)',
    ...
    {
        $pos = LeagueRefTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['LeagueRef'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['LeagueRef'][$this->hashCode()] = true;
        $keys = LeagueRefTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getLeague(),
        );
    ...
    /**
     * Generic method to set the primary key (league column).
     *
     ...
     * objects.
     *
     * @param      object $copyObj An object of \LeagueRef (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \LeagueRef Clone of current object.
     * @throws PropelException
     */
     ...
     * If this ChildLeagueRef is new, it will return
    ...
    public function setTeamss(Collection $teamss, ConnectionInterface $con = null)
    {
        ...
        foreach ($teamssToDelete as $teamsRemoved) {
            $teamsRemoved->setLeagueRef(null);
        }
     ...
     * Otherwise if this LeagueRef is new, it will return
     * an empty collection; or if this LeagueRef has previously
     * been saved, it will retrieve related Teamss from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in LeagueRef.
     *
     * @param      Criteria $criteria optional Criteria object to narrow the query
     * @param      ConnectionInterface $con optional connection object
     ...
     * @return ObjectCollection|ChildTeams[] List of ChildTeams objects
     */
    public function getTeamssJoinDivisionRef(Criteria $criteria = null, ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildTeamsQuery::create(null, $criteria);
    ...
    {
        return (string) $this->exportTo(LeagueRefTableMap::DEFAULT_STRING_FORMAT);
    }
