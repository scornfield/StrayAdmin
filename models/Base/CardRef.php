...
/**
 * Base class that represents a row from the 'card_ref' table.
 *
 *
 *
* @package    propel.generator..Base
*/
abstract class CardRef implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\CardRefTableMap';
    ...
    /**
     * Initializes internal state of Base\CardRef object.
     */
    ...
    /**
     * Compares this with another <code>CardRef</code> instance.  If
     * <code>obj</code> is an instance of <code>CardRef</code>, delegates to
     * <code>equals(CardRef)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|CardRef The current object, for fluid interface
     */
     ...
     * @return $this|\CardRef The current object (for fluent API support)
     */
    public function setCard($v)
    {
        ...
        if ($this->card !== $v) {
            $this->card = $v;
            $this->modifiedColumns[CardRefTableMap::COL_CARD] = true;
        }
    ...
    public function setMeaning($v)
    {
        ...
        if ($this->meaning !== $v) {
            $this->meaning = $v;
            $this->modifiedColumns[CardRefTableMap::COL_MEANING] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : CardRefTableMap::translateFieldName('Card', TableMap::TYPE_PHPNAME, $indexType)];
            $this->card = (null !== $col) ? (boolean) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : CardRefTableMap::translateFieldName('Meaning', TableMap::TYPE_PHPNAME, $indexType)];
            $this->meaning = (null !== $col) ? (string) $col : null;
            $this->resetModified();
            ...
            return $startcol + 2; // 2 = CardRefTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\CardRef'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildCardRefQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see CardRef::setDeleted()
     * @see CardRef::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildCardRefQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                CardRefTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(CardRefTableMap::COL_CARD)) {
            $modifiedColumns[':p' . $index++]  = 'card';
        }
        if ($this->isColumnModified(CardRefTableMap::COL_MEANING)) {
            $modifiedColumns[':p' . $index++]  = 'meaning';
        }

        $sql = sprintf(
            'INSERT INTO card_ref (%s) VALUES (%s)',
    ...
    {
        $pos = CardRefTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['CardRef'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['CardRef'][$this->hashCode()] = true;
        $keys = CardRefTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getCard(),
            $keys[1] => $this->getMeaning(),
        );
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) {
            $this->setCard($arr[$keys[0]]);
        }
        if (array_key_exists($keys[1], $arr)) {
            $this->setMeaning($arr[$keys[1]]);
        }
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(CardRefTableMap::COL_MEANING)) {
            $criteria->add(CardRefTableMap::COL_MEANING, $this->meaning);
        }
    ...
    /**
     * Generic method to set the primary key (card column).
     *
     * @param       boolean $key Primary key.
     * @return void
     */
     ...
     * objects.
     *
     * @param      object $copyObj An object of \CardRef (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \CardRef Clone of current object.
     * @throws PropelException
     */
     ...
     * If this ChildCardRef is new, it will return
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildCardRef The current object (for fluent API support)
     */
    public function setPlayerss(Collection $playerss, ConnectionInterface $con = null)
    {
        ...
        foreach ($playerssToDelete as $playersRemoved) {
            $playersRemoved->setCardRef(null);
        }
     ...
     * Otherwise if this CardRef is new, it will return
     * an empty collection; or if this CardRef has previously
     * been saved, it will retrieve related Playerss from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in CardRef.
     *
     * @param      Criteria $criteria optional Criteria object to narrow the query
     * @param      ConnectionInterface $con optional connection object
    ...
    {
        return (string) $this->exportTo(CardRefTableMap::DEFAULT_STRING_FORMAT);
    }
